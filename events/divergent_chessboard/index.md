---
layout: event
title: "Альтернативные Шахматы"
slug: divergent_chessboard
chapters_count: 19
black_scene:
  - "Операция «Альтернативные Шахматы»"
  - "Если два враждебных слона стоят на полях разного цвета, им суждено никогда не встретиться."
  - "..."
black_scene1:
  - "...Кто...я?..."
  - "...Просто кто я...на самом деле...?"
black_scene2:
  - "...Всё не должно было быть так..."
  - "Чтобы стать достаточно сильной для защиты Железной Крови, для защиты моих союзников..."
  - "Я принесла столько жертв, уничтожила столько врагов, просто следуя «приказам»."
  - "Я смирилась с тем, что стала лишь «Фигурой» для наших ненавистных врагов, 「 」..."
  - "Акаги... Что же ты там задумала?"
black_scene3:
  - "...Прощай..."
  - "...другая «я» по ту сторону зеркала, которую мне никогда не суждено встретить..."
black_scene4:
  - "«О, моЙ доРОгой ТвоРЕц...»"
  - "«ПоЖаЛуйста, скаЖИ мне, чТО мы коГДА-ниБУдь встреТИМся сноВА...»"
---
<style>
  h1.title { color: red;}
</style>
...
<p class="title-1">Альтернативные шахматы - Приквел</p>
{% include blackscreen.html lines=page.black_scene %}
{% assign rows = site.data.divergent_chessboard.part1.chapter1.rows %}
...
<p class="title-1">Альтернативные шахматы - Сиквел</p>
{% assign rows = site.data.divergent_chessboard.part9.chapter1.rows %}
{% include dialog.html rows=rows bg_class="table-bg" %}
</div> <!-- конец главы -->
