...
<img class="pict1" src="../../img/bg/p/bg48.webp" alt="">
...
<img class="pict1" src="../../img/bg/p/bg49.webp" alt="">
...
<img class="pict1" src="../../img/bg/i/bg3-1.webp" alt="">
{% include loc.html td_class="loc" text="Мозамбикский пролив · Зона контроля Доминиона Виши" %}
{% assign rows = site.data.skybound_oratorio.part15.chapter1.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/i/bg3-1.webp"  %}
{% include blackscreen.html lines=page.black_scene99 %}
...
<img class="pict1 memory-segment" src="../../img/bg/i/bg2-2.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg memory-segment" bg_file="/img/bg/i/bg2-2.webp"  %}
{% include blackscreen.html lines=page.black_scene99 %}
...
<img class="pict1" src="../../img/bg/i/bg3-2.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/i/bg3-2.webp"  %}
</div> <!-- конец главы -->
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/i/bg3-2.webp"  %}
<img class="pict1" src="../../img/bg/p/bg50.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/i/bg3-1.webp"  %}
<img class="pict1" src="../../img/bg/p/bg51.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg memory-segment" bg_file="/img/bg/y/bg2.webp"  %}
{% include blackscreen.html lines=page.black_scene99 %}
