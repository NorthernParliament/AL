...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/z/bg3.webp" %}
<img class="pict1" src="../../img/bg/p/bg31.webp" alt="">
{% assign rows = site.data.ashen_simulacrum.part29.chapter2.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/z/bg3.webp" %}
<img class="pict1" src="../../img/bg/p/bg32.webp" alt="">
<img class="pict1" src="../../img/bg/p/bg33.webp" alt="">
<img class="pict1" src="../../img/bg/p/bg34.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/z/bg3.webp" bg_overlay="blue-choise" %}
{% assign rows = site.data.ashen_simulacrum.part30.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/z/bg3.webp" bg_overlay="red-choise" %}
