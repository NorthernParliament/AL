...
<img class="pict1 fog-effect" src="../../img/bg/x/bg5-1.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg mist" bg_file="/img/bg/x/bg5-1.webp" %}
</div> <!-- конец главы -->
...
{% include dialog.html rows=rows bg_class="table-bg mist" bg_file="/img/bg/z/bg3.webp" %}
...
{% include dialog.html rows=rows bg_class="table-bg mist" bg_file="/img/bg/z/bg3.webp" %}
<img class="pict1 fog-effect" src="../../img/bg/x/bg7.webp" alt="">
