...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg5.webp"  %}
<img class="pict1" src="../../img/bg/c/bg7.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part2.chapter2.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg7.webp"  %}
{% include choice_header.html %}
{% assign rows = site.data.parallel_superimposition.part2.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg7.webp" bg_overlay="blue-choise" %}
{% assign rows = site.data.parallel_superimposition.part2.chapter4.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg7.webp" bg_overlay="red-choise" %}
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg7.webp"  %}
<img class="pict1" src="../../img/bg/y/bg7.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg5.webp"  %}
<img class="pict1" src="../../img/bg/y/bg8.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/y/bg8.webp"  %}
<img class="pict1" src="../../img/bg/a/bg5.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part6.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg5.webp"  %}
<img class="pict1" src="../../img/bg/p/bg115.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg7.webp" bg_overlay="yellow-choise" %}
...
<img class="pict1" src="../../img/bg/a/bg6-1.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg6-1.webp" %}
</div> <!-- конец главы -->
...
<img class="pict1" src="../../img/bg/a/bg4-1.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg4-1.webp" %}
</div> <!-- конец главы -->
...
<img class="pict1" src="../../img/bg/x/bg16.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part15.chapter1.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16.webp" %}
{% include divider.html %}
<div class="image-overlay-container">
    <img class="base-image pict1" src="../../img/bg/u/bg3-4.webp" alt="">    
    <img class="overlay-layer pict1" src="../../img/bg/bgm.webp" alt="">
</div>
{% assign rows = site.data.parallel_superimposition.part15.chapter2.rows %}
{% include dialog.html rows=rows bg_class="table-bg memory-segment" bg_file="/img/bg/u/bg3-4.webp" %}
{% include divider.html %}
<img class="pict1" src="../../img/bg/x/bg16.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/y/bg3.webp" %}
<img class="pict1" src="../../img/bg/p/bg116.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8.webp" %}
{% include choice_header.html %}
{% assign rows = site.data.parallel_superimposition.part18.chapter2.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8.webp" bg_overlay="blue-choise" %}
{% assign rows = site.data.parallel_superimposition.part18.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8.webp" bg_overlay="red-choise" %}
</div> <!-- конец главы -->
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16.webp" %}
<img class="pict1" src="../../img/bg/p/bg117.webp" alt="">
...
<img class="pict1" src="../../img/bg/x/bg16-1.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg memory-segment" bg_file="/img/bg/m/bg1-4.webp" %}
{% include divider.html %}
<img class="pict1" src="../../img/bg/x/bg16-1.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part25.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16-1.webp" %}
<img class="pict1" src="../../img/bg/p/bg118.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part25.chapter4.rows %}
{% include dialog.html rows=rows bg_class="table-bg" %}
<img class="pict1" src="../../img/bg/p/bg118-1.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part25.chapter5.rows %}
{% include dialog.html rows=rows bg_class="table-bg" %}
<img class="pict1" src="../../img/bg/p/bg118-2.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part25.chapter6.rows %}
{% include dialog.html rows=rows bg_class="table-bg" %}
<img class="pict1" src="../../img/bg/x/bg16-2.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part25.chapter7.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16-2.webp" %}
{% include choice_header.html %}
{% assign rows = site.data.parallel_superimposition.part25.chapter8.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16-2.webp" bg_overlay="blue-choise" %}
{% assign rows = site.data.parallel_superimposition.part25.chapter9.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16-2.webp" bg_overlay="red-choise" %}
{% assign rows = site.data.parallel_superimposition.part25.chapter10.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg16-2.webp" %}
{% include divider.html %}
<div class="image-overlay-container">
    <img class="base-image pict1" src="../../img/bg/y/bg6.webp" alt="">    
    <img class="overlay-layer pict1" src="../../img/bg/bgm.webp" alt="">
</div>
{% assign rows = site.data.parallel_superimposition.part25.chapter11.rows %}
{% include dialog.html rows=rows bg_class="table-bg memory-segment" bg_file="/img/bg/y/bg6.webp" %}
{% include whitescreen.html lines=page.white_scene99 %}
...
<img class="pict1" src="../../img/bg/p/bg119.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8.webp" %}
<img class="pict1" src="../../img/bg/p/bg116-1.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part28.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8.webp" %}
{% include whitescreen.html lines=page.white_scene99 %}
<img class="pict1" src="../../img/bg/c/bg8-1.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part28.chapter4.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/c/bg8-1.webp" %}
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg4.webp" bg_overlay="blue-choise" %}
{% assign rows = site.data.parallel_superimposition.part29.chapter3.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/a/bg4.webp" bg_overlay="red-choise" %}
...
<img class="pict1" src="../../img/bg/s/bg9.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/s/bg9.webp" %}
{% include blackscreen.html lines=page.black_scene99 %}
...
<img class="pict1" src="../../img/bg/p/bg17.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/y/bg3.webp" %}
<img class="pict1" src="../../img/bg/p/bg122.webp" alt="">
{% assign rows = site.data.parallel_superimposition.part35.chapter10.rows %}
{% include dialog.html rows=rows bg_class="table-bg" %}
<img class="pict1" src="../../img/bg/p/bg123.webp" alt="">
