...
<style>
h1.title { color: #f5f8f7;}
</style>

<div class="chapter" id="part1"> <!-- начало главы -->
<p class="title-1">Преддверие Ада</p>
{% include blackscreen.html lines=page.black_scene %}
<img class="pict1" src="{{ site.baseurl }}/img/bg/e/bg1.webp" alt="">
{% assign rows = site.data.empyreal_tragicmedy.part1.chapter1.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/e/bg1.webp" %}
<img class="pict1" src="{{ site.baseurl }}/img/bg/y/bg1.webp" alt="">
...
<img class="pict1" src="{{ site.baseurl }}/img/bg/u/bg2.webp" alt="">
{% assign rows = site.data.empyreal_tragicmedy.part4.chapter2.rows %}
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/u/bg2.webp" %}
</div> <!-- конец главы -->
...
<img class="pict1" src="{{ site.baseurl }}/img/bg/p/bg6.webp" alt="">
...
<img class="pict1" src="{{ site.baseurl }}/img/bg/p/bg7.webp" alt="">
{% include loc.html td_class="loc" text="Королевские Острова" %}
...
<img class="pict1" src="{{ site.baseurl }}/img/bg/x/bg2.webp" alt="">
...
{% include dialog.html rows=rows bg_class="table-bg" bg_file="/img/bg/x/bg2.webp" %}
<img class="pict1" src="{{ site.baseurl }}/img/bg/p/bg5.webp" alt="">
